...
SELECT
    JSON_OBJECT(
     ...
     'pur_date' VALUE to_char(drone_pur_date,'dd-Mon-yyyy'),
     ...
     'RentalInfo' VALUE JSON_ARRAYAGG (
          JSON_OBJECT (
            ...
            'rent_out' VALUE to_char(rent_out_dt,'dd-Mon-yyyy hh24:mi:ss'),
            'rent_in' VALUE to_char(rent_in_dt ,'dd-Mon-yyyy hh24:mi:ss'),
